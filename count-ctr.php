...
<div class="text row">
	...
	<div class="col-left-2">
		<h2>CTR Titolo Alternativo</h2>
			<div class="c100 p'.$points.'">
				<span class="hover-dif">'.$points.'%</span>
					<div class="slice">
	...
	<h2> Titolo Alternativo </h2>
		<input style="width: 100%;" type="text" name="post_subtitle" value="#1" id="subtitle" spellcheck="true" autocomplete="off">
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Non sono presenti numeri. Se possibile prova ad inserirne uno che identifichi un obiettivo o un risultato.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Non sono presenti parole emozionali. Prova ad inserire una delle seguenti parole.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Non sono presenti parole che esprimono un sentimento. Prova ad inserire una delle seguenti parole. </p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Evita gli errori grammaticali. Se sei sicuro che non siano presenti, salta questo step.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Non sono presenti caratteri speciali. Prova ad inserire uno di questi caratteri.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Il testo contiene meno di quattro parole. Prova ad aggiungerne altre.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Il testo non contiene più di una parola maiuscola. Non preoccuparti se non è grammaticalmente corretto. I titol web prevedono questo tipo di scrittura.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Evita di scrivere più di 8 parole.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Nonostante sia presente un numero, quest&rsquo;ultimo non si trova all&rsquo;inizio. Se possibile spostalo almeno tra le prime tre parole.</p>
		</div>
		<div class="cornice">
			<p><span class="text-font">Suggerimento: </span>Evita di inserire troppi caratteri speciali.</p>
		</div>
